...
To define your own palette for a numeric variable, you can provide 2 or 3 colors defining the lower, upper, and middle segments of the palette.
...
When the color scheme is clear and the `annotate_feature` argument draws the exact values of the feature, it makes sense to get rid of the legend using the `theme()` function from `ggplot2`:
